            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-4 duration-500">
                <div className="p-8">
                    <div className="text-xl md:text-2xl font-bold text-gray-800 mb-6 leading-relaxed">
                        ...
                        {currentQuestion.text.split('\n').some(line => line.includes('=') || line.includes('print(') || line.includes('if ') || line.includes('for ')) ? (
                            <div>
                                <p className="mb-4">{currentQuestion.text.split('\n')[0]}</p>
                                <pre className="bg-gray-100 p-4 rounded-lg font-mono text-sm text-gray-700 overflow-x-auto border border-gray-200 shadow-sm leading-relaxed">
                                    {currentQuestion.text.split('\n').slice(1).join('\n')}
                                </pre>
                            </div>
                        ) : (
